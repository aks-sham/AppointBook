...
public class ShowAppoin extends HttpServlet {
...
"        </form>");
             out.println(        "<table border='3' bordercolor='green' style='margin-left: 26.7%;'>" +
             ...
             try
        {
            ...
            String sqlString = "SELECT NAME,EMAIL,ADDRESS, MOBILE, ADATE, REASON FROM appoin WHERE doctor='"+ id +"'";
